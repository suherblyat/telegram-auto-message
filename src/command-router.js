...
const BOOKS = {
  ...
  "ruta": b("Ruth", "Рута"),
  "1 samuilova": b("1 Samuel", "1. Самуилова"),
  "2 samuilova": b("2 Samuel", "2. Самуилова"),
  "1 carevima": b("1 Kings", "1. Царевима"),
  "2 carevima": b("2 Kings", "2. Царевима"),
  "1 dnevnika": b("1 Chronicles", "1. Дневника"),
  "2 dnevnika": b("2 Chronicles", "2. Дневника"),
  "jezdra": b("Ezra", "Јездра"),
  "nemija": b("Nehemiah", "Немија"),
  "jestira": b("Esther", "Јестира"),
  "jov": b("Job", "Јов"),
  ...
  "plac jeremijin": b("Lamentations", "Плач Јеремијин"),
  "jezekilj": b("Ezekiel", "Језекиљ"),
  "danilo": b("Daniel", "Данило"),
  "osija": b("Hosea", "Осија"),
  "joil": b("Joel", "Јоил"),
  "amos": b("Amos", "Амос"),
  "avdija": b("Obadiah", "Авдија"),
  "jona": b("Jonah", "Јона"),
  "mihej": b("Micah", "Михеј"),
  "naum": b("Nahum", "Наум"),
  "avakum": b("Habakkuk", "Авакум"),
  "sofonija": b("Zephaniah", "Софонија"),
  "agej": b("Haggai", "Агеј"),
  "zaharija": b("Zechariah", "Захарија"),
  "malahija": b("Malachi", "Малахија"),
